            ...
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="vuelosDropdown">
                        ...
                        <li><a class="dropdown-item active" href="alta-vuelo.jsp"><i class="bi bi-plus-circle"></i> Alta de Vuelo</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown active">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="aerolineasDropdown">
                        ...
                        <li><a class="dropdown-item active" href="alta-vuelo.jsp"><i class="bi bi-airplane"></i> Alta de Vuelo</a></li>
                    </ul>
                </li>
        ...
        <div class="card-body">
            ...
            <form id="formAltaVuelo" novalidate>
                ...
                <div class="alert alert-info">
                    <strong>Aerolínea:</strong> ZulyFly Airlines
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="rutaVuelo" required>
                        ...
                        <option value="ZL1502">ZL1502 - Montevideo a Rio de Janeiro</option>
                        <option value="ZL2001">ZL2001 - Montevideo a São Paulo</option>
                        <option value="ZL3005">ZL3005 - Buenos Aires a Santiago</option>
                        <option value="ZL4002">ZL4002 - Lima a Bogotá</option>
                    </select>
