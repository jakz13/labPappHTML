            ...
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="usuariosDropdown">
                        ...
                        <li><a class="dropdown-item active" href="modificar-usuario.jsp"><i class="bi bi-pencil-square"></i> Modificar Datos</a></li>
                    </ul>
                </li>
            </ul>
...
<script src="js/JsLogica/modificar-usuario.js"></script>
</body>
</html>