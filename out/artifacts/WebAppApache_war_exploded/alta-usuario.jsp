...
<head>
    ...
    <title>Registro de Usuario - Juan Viajes</title>
    <!-- Bootstrap -->
            ...
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="usuariosDropdown">
                        <li><a class="dropdown-item active" href="alta-usuario.jsp"><i class="bi bi-person-plus"></i> Alta de Usuario</a></li>
        ...
        <div class="col-lg-8">
            <div class="card shadow-lg">
                <div class="card-header bg-primary text-white text-center">
                    <h4 class="mb-0">Crear Cuenta en Juan Viajes</h4>
                    <p class="mb-0 mt-2 small">Únete a nuestra comunidad de viajeros</p>
                </div>
                <div class="card-body p-4">
                    ...
                    <div class="step-indicator">
                        <div class="step active" id="step1">
                            ...
                            <div class="step-label small">Datos Básicos</div>
                        </div>
                        <div class="step" id="step2">
                            <div class="step-number">2</div>
                            <div class="step-label small">Tipo de Usuario</div>
                        </div>
                        <div class="step" id="step3">
                            <div class="step-number">3</div>
                            <div class="step-label small">Información Adicional</div>
                        </div>
                    </div>
                    ...
                    <form id="formRegistroUsuario" novalidate>
                        ...
                        <div class="form-section active" id="section1">
                            ...
                            <div class="mb-3">
                                <label for="imagenUsuario" class="form-label">Foto de Perfil (opcional)</label>
                                <input type="file" class="form-control" id="imagenUsuario" accept="image/*">
                        ...
                        <div class="form-section d-none" id="section2">
                            <h5 class="text-primary mb-3">Tipo de Usuario</h5>

                            <div class="mb-4">
                                <label class="form-label">Seleccione el tipo de cuenta *</label>
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <div class="card h-100 user-type-card" id="clienteCard" onclick="selectUserType('cliente')">
                                            <div class="card-body text-center">
                                                <h6>Cliente</h6>
                                                <p class="small text-muted">Para viajeros que desean reservar vuelos y comprar paquetes</p>
                                                <span class="badge bg-primary">Seleccionar</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <div class="card h-100 user-type-card" id="aerolineaCard" onclick="selectUserType('aerolinea')">
                                            <div class="card-body text-center">
                                                <h6>Aerolínea</h6>
                                                <p class="small text-muted">Para empresas que desean publicar rutas y vuelos</p>
                                                <span class="badge bg-primary">Seleccionar</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <input type="hidden" id="tipoUsuario" required>
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="button" class="btn btn-primary" id="nextStep2" onclick="nextStep(3)" disabled>Siguiente</button>
                            </div>
                        </div>
                        ...
                        <div class="form-section d-none" id="section3">
                            ...
                            <div id="camposCliente" class="d-none">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <label for="numeroDocumento" class="form-label">Número *</label>
                            ...
                            <div id="camposAerolinea" class="d-none">
                                <div class="mb-3">
                                    <label for="descripcionAerolinea" class="form-label">Descripción General *</label>
                                    <textarea class="form-control" id="descripcionAerolinea" rows="3"></textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-text">Enlace a su sitio web oficial.</div>
                                </div>
                            </div>
            ...
            <div class="text-center mt-3">
                <p>¿Ya tienes una cuenta? <a href="#" class="text-primary" data-bs-toggle="modal" data-bs-target="#loginModal">Inicia sesión aquí</a></p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-success text-white">
                <h5 class="modal-title" id="successModalLabel">¡Cuenta Creada Exitosamente!</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body text-center">
                ...
                <h5>Bienvenido a Juan Viajes</h5>
...
<script src="js/JsLogica/alta-usuario.js"></script>
</body>
</html>