            ...
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="vuelosDropdown">
                        ...
                        <li><a class="dropdown-item active" href="consulta-reserva.jsp"><i class="bi bi-ticket-perforated"></i> Consulta de Reserva</a></li>
...
<script src="js/JsLogica/consulta-reserva.js"></script>
</body>
</html>