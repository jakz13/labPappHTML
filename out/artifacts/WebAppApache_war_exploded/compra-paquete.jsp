        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="paquetesDropdown">
                        ...
                        <li><a class="dropdown-item active" href="compra-paquete.jsp"><i class="bi bi-cart-check"></i> Compra de Paquete</a></li>
            ...
            <div class="user-actions">
                <span class="user-info" id="userInfo">
                    <i class="bi bi-person-circle"></i> María González
                </span>
...
<script src="js/JsLogica/compra-paquete.js"></script>
</body>
</html>