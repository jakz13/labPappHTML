            ...
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="usuariosDropdown">
                        ...
                        <li><a class="dropdown-item active" href="consulta-usuario.jsp"><i class="bi bi-person-vcard"></i> Consulta de Usuario</a></li>
...
<script src="js/JsLogica/consulta-usuario.js"></script>
</body>
</html>