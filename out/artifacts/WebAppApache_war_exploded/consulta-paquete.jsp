            ...
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="paquetesDropdown">
                        <li><a class="dropdown-item active" href="consulta-paquete.jsp"><i class="bi bi-box-seam"></i> Consulta de Paquete</a></li>
...
<script src="js/JsLogica/consulta-paquete.js"></script>
</body>
</html>